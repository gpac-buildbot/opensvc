...
#ifdef MMX
#define SVC4x4Store SVC4x4Store_MMX
#else
#define SVC4x4Store SVC4x4Store_C
#endif
...
/**
Add to the residual buffer, residual from the current macroblock.
*/
...
/**
Store into the residual buffer, residual from the current macroblock.
*/
static __inline void SVC4x4Store_C (short * RESTRICT  block, short *image,const int PicWidthInPix)
{
	__declspec(align(16)) short BlockTemp[16];
	int     i, j = 0 ;
...
Store into the residual buffer, residual from the current macroblock.
*/
static __inline void SVC4x4Store_MMX (short * RESTRICT  block, short *image,const int PicWidthInPix)
{
